      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative w-full aspect-square max-w-2xl mx-auto">
          ...
          {stages.map((stage, index) => {
            ...
            const radius = 32; // Reduced from 35 to bring circles even closer
            ...
            return (
              <motion.button
                ...
                className={`absolute w-22 h-22 -ml-11 -mt-11 rounded-full flex flex-col items-center justify-center transition-all duration-300 ${
              ...
              >
                ...
                <span className="text-[11px] text-center px-1 leading-tight">{stage.name}</span>
              </motion.button>
            );
          })}
        </div>
