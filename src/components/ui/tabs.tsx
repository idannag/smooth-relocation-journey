...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-md bg-gradient-to-r from-[#F6F6F7]/80 to-[#F1F1F1]/80 p-1 text-muted-foreground shadow-sm",
      className
    )}
    {...props}
  />
