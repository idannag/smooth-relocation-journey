  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in font-poppins">
          <span className="bg-gradient-to-r from-[#221F26] to-[#33C3F0] bg-clip-text text-transparent drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
