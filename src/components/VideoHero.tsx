  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in font-poppins bg-gradient-to-r from-[#FC466B] to-[#3F5EFB] bg-clip-text text-transparent [-webkit-text-stroke:_0.5px_rgba(255,255,255,0.3)]">
