    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {services.map(service => (
          <Card key={service.id} className="overflow-hidden border border-gray-200 hover:shadow-md transition-shadow">
            <div className="p-6">
      ...
      <Dialog open={showForm} onOpenChange={setShowForm}>
        <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold bg-gradient-to-r from-[#2C5AAE] to-[#40E0D0] bg-clip-text text-transparent">
              Request Service Information
            </DialogTitle>
            <DialogDescription className="text-gray-600">
              {formData.service 
                ? `Tell us more about your needs for ${formData.service}` 
                : 'Fill out this form to learn more about our relocation services'}
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <div className="pt-2 flex gap-4">
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-[#2C5AAE] to-[#40E0D0] hover:opacity-90 transition-opacity"
              >
