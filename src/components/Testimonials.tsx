...
const Testimonials = () => {
  ...
  const [scrollRef = useRef < HTMLDivElement > (null);
      ...
      const fetchGoogleReviews = async () => {
        try {
          const {
            data,
            error
          } = await supabase.functions.invoke('getGoogleReviews');
      ...
      return ( <
        ...
        div className = "grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl" > {
          [1, 2, 3].map((i) => ( <
            ...
            className = "bg-white p-6 rounded-lg shadow h-48" >
            < /div>
          ))
        } <
        /div> <
    ...
    return ( <
      ...
      <
      img src = "/lovable-uploads/7fc61af8-ea7f-4585-8f82-c8a61f99c608.png"
      alt = "Google Reviews"
      ...
      <
      button onClick = {
        () => handleOpenReviewLink("https://maps.app.goo.gl/3DkAx4B6kb8Q1B9J7")
      }
      ...
      /button> <
      button onClick = {
        () => handleOpenReviewLink("https://search.google.com/local/writereview?placeid=ChIJc0HHe0tHHRUR4G4V7hGPL08")
      }
