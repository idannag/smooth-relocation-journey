...
const Statistics = () => {
  ...
  return (
    <section className="py-6 sm:py-12 bg-gradient-to-br from-white via-blue-50 to-white">
              ...
              {isMobile ? (
                ...
                <div className="flex items-center gap-4">
                  <div className="relative flex-shrink-0">
                    ...
                    <stat.icon className="w-12 h-12 text-[#2C5AAE] transform group-hover/stat:scale-110 transition-transform duration-500" />
                  </div>
                  <div className="flex-1">
                    <p className="text-gray-600 text-sm font-medium">{stat.topText}</p>
                    <div className="flex items-baseline gap-1">
                      <h3 className="text-2xl font-bold text-[#2C5AAE] transform group-hover/stat:translate-y-[-2px] transition-transform duration-500">
                        {stat.number}
                      </h3>
